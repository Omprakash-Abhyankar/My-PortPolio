...
const Contact = () => {
  ...
  const contact_info =[
    {logo:<HiOutlineMail/>, text:'omabhyankar815@gmail.com'},
    {logo:<BsWhatsapp/>, text:'+91 8999624923'},
    {logo:<GoLocation/>, text:'Isasani CRPF Camp Hingna Road Nagpur 440019 .'}
  ]
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_5k04h4u', 'template_coe4i0h', form.current, 'y9-TjMXUCvkIfvRosNSZf')
      .then((result) => {
