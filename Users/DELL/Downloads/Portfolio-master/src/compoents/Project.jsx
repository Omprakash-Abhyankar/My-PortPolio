...
// import Project5 from '../assets/images/Screenshot (1).png'
...
const Project = () => {
  const projects =[
    {img:Project1,
      name:'Movix App',
     github_link : 'https://github.com/omprakash-abhyankar/Screenshot (1)',
      live_link: 'https://movix-gules.vercel.app/'
    },
    {img:Project2,
      name:'Exercise App',
     github_link : 'https://github.com/omprakash-abhyankar/Exercise-React-App',
      live_link: 'https://exercise-add.netlify.app/'
    },
    {img:Project3,
      name:'Travigo App',
     github_link : 'https://github.com/omprakash-abhyankar/Travigo-Traval-Agency',
      live_link: 'https://travigo-agency.netlify.app/'
    },
    {img:Project4,
      name:'Nike App',
     github_link : 'https://github.com/omprakash-abhyankar/Nike-Store',
      live_link: 'https://nike-bazar.netlify.app/'
    },
    {img:Project5,
      name:'Personal App',
     github_link : 'https://github.com/omprakash-abhyankar/website',
...
// <a href={projects_info.live_link} target='_blank' className='text-cyan-600 bg-gray-800 px-2 py-1 inline-block'>Live Demo</a>
//         </div>
//         </div>
//       </SwiperSlide>
//         ))
